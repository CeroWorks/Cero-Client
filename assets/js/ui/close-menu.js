...
document.addEventListener('click', (e) => {
    ...
    Cero.modules.showCloseMenu = showCloseMenu; window.showCloseMenu = showCloseMenu;
    Cero.modules.hideCloseMenu = hideCloseMenu; window.hideCloseMenu = hideCloseMenu;
})(window);
